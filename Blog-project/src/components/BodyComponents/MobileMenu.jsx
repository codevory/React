...
<div id='menuContent' className={`flex-col w-full h-screen flex gap-0.5 mt-4 transition-transform ease-in duration-300 ${isDark ? 'bg-zinc-900' : 'bg-zinc-400'}  ${isOn ? 'traslate-x-10 flex ' : '-translate-x-50 hidden'}`}>
