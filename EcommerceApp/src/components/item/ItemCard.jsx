...
let res = slugify(item.title)
      return (
        ...
        <div className='flex gap-1 bg-yellow-300 w-full'>
          <h2 className='text-[12px] overflow-hidden w-[80%] h-5'>{item.title}</h2>
          <span className='flex gap-1 w-[20%] items-center text-[14px] '>{item.rating}
